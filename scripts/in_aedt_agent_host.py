...
def _dispatch_command(command, running_path, oDesktop, context, logger):
    ...
    if action == "run_2d_screen":
        ...
        return {"command": command, "result": "2d_screen_complete", "snapshot": session_snapshot(oDesktop, context)}
    if action == "run_3d_validation":
        ...
        return {"command": command, "result": "3d_validation_complete", "snapshot": session_snapshot(oDesktop, context)}
