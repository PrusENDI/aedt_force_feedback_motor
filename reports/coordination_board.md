...
| Sector3D Solve | agent/sector3d-solve | excitation/setup/reports/solve | blocked | 8b31b49 | latest excitation run still cannot create Maxwell 3D winding/current boundaries and then fails project save/open on the downstream report/solve queue |
